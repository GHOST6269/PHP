        ...
        public function id(){
            ...
            while($data = $a->fetch()){
                ...
                <tr>
                    ...
                    <td>
                        <div id="delete">
                            <button class="btn btn-danger delete" type="submit" data-toggle="modal" data-target="#delete">X</button>

                            <form action="http://localhost/exo/index.php?action=delete" method="POST">
                        ...
                        <div class="delete" style="display: inline-block ; ">                                
                            <button class="btn btn-primary  delete" type="submit" data-toggle="modal" data-target="#myModal">U</button>
                            <form action="http://localhost/exo/index.php?action=update" method="POST">
